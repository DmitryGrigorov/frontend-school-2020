...
delay(1000).then(() => console.log('delay callback 1'));
delay(2000).then(() => console.log('delay callback 2'));
delay(3000).then(() => console.log('delay callback 3'));
...
const someUrl = 'http://echo.jsontest.com/id/123/name/sasha/completed/true';

function request() {
    return fetch(someUrl).then(response => response.json())
}
