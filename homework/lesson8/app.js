...
// //       Для собственного понимания (без учета нового запроса из условия задачи дз) 
//     fetch('http://echo.jsontest.com/id/qwerty/name/petya')
    
//         .then ((response) => {
//            return response.text();    // response.text() возвращает новый промис, который выполняется и возвращает полный ответ сервера
//         })
//         .then ((text) => {            // содержимое полученного файла
//             console.log(text);        // { id: 'qwerty', name: 'petya' }
//         });
...
//                 .then((response) => {
//                     return response.text();  // при использовании response.json() в консоль выводится Object с содержимым  { id: 'qwerty', name: 'petya' } 
//                 })
//         }
//         request(someUrl)
//             .then((data) => { 
//                 console.log(data); 
//             });                              // выведет в консоль { id: 'qwerty', name: 'petya' }
