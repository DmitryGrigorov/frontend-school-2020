...
//let i = 0;
//while (++i < 5) alert( i );
//Для цикла с префиксным вариантом ++i
//Ответ: 1 2 3 4

//i = 0;
//while (i++ < 5) alert( i );

//Для цикла с постфиксным вариантом i++
//Ответ: 1 2 3 4 5
...
function pow(x,n) {
    return (typeof(x) == "number" && typeof(n) === "number") ? (x) ** (n) : "Введены одно или оба неверных значений";
}
